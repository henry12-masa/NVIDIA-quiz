...
const quizInfo = {
  nvidiaAiInfra: {
    title: "NVIDIA Certified Associate AI Infrastructure",
    desc: "GPU基盤・AIインフラ・ネットワーク・ストレージ・運用監視の基礎"
  },
  nvidiaProfessionalAi: {
    title: "NVIDIA Certified Professional AI",
    desc: "AIモデル開発・推論・GPU最適化・MLOps・生成AI活用"
  },
  sasViyaProgramming: {
    title: "SAS Viya Programming Associate",
    desc: "SAS Viya・CAS・データ操作・プログラミング・分析処理"
  },
  clouderaDataAnalyst: {
    title: "Cloudera Certified Associate Data Analyst",
    desc: "SQL・Hive/Impala・データ分析・集計・ビッグデータ基礎"
  }
};
...
if (type === "all") {
  document.title = "AI・データ分析資格クイズ";
  pageTitle.textContent = "AI・データ分析資格クイズ";
  pageDesc.textContent = "4カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.nvidiaAiInfra;
